...
call s:h("LineNr",        {"fg": s:light_black, "bg": s:bg_dark})
call s:h("CursorLineNr",  {"fg": s:red, "bg": s:bg_subtle})
...
call s:h("DiffAdd",       {"fg": s:white, "bg": s:green, "gui": "bold", "cterm": "bold"})
call s:h("DiffDelete",    {"fg": s:red, "bg": s:red})
call s:h("DiffChange",    {"fg": s:white, "bg": s:dark_yellow, "gui": "bold", "cterm": "bold"})
call s:h("DiffText",      {"fg": s:white, "bg": s:dark_blue, "gui": "bold", "cterm": "bold"})
